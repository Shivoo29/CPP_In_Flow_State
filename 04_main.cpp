...
//
// This file uses functions declared in 05_headerFiles.h and defined in
// 03_functions.cpp, so build both together:
//     g++ 04_main.cpp 03_functions.cpp -o main
// ============================================================

#include <iostream>
#include "05_headerFiles.h"    // quotes = look next to this file
...
int main() {
    ...
    result(a, b);  // declared in 05_headerFiles.h, body lives in 03_functions.cpp
    ...
    for(int i=0; i<5; i++){
        log(i);   // log() is defined inline in 05_headerFiles.h
    }
    return 0;
}
